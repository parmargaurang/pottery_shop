...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" required placeholder="enter product description" name="description" maxlength="255" class="box" value="<?= $fetch_products['description']; ?>">
      ...
      <select name="category" class="box" required>
         ...
         <option value="Other products">Others Products</option>
      </select>
