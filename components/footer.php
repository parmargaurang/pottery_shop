...
<div class="pg-footer">
  ...
  <footer class="footer">
       ...
       <div class="footer-col">
         ...
         <div class="footer-col">
             ...
             <li><a href="cart.php"><i class="fas fa-angle-right"></i>Cart</a></li>
  	 				<li><a href="orders.php"><i class="fas fa-angle-right"></i>Orders</a></li>
       ...
       <div class="footer-col">
  	 			...
  	 			<ul>
  	 				<li><a><i class="fas fa-map-marker-alt"></i>mypottery - pottery Shop
                   507-Union Trade Centre
                   India</a></li>
  	 				<li><a><i class="fas fa-envelope"></i>pottery12@gmail.com</a></li>
  	 				<li><a><i class="fas fa-phone"></i>(+91) 9876-543-210</a></li>
